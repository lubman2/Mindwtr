...
- Confirm Android Play distribution reaches both internal testing and open testing (`beta`) when Play upload is enabled.
- Compare the standard Android build and the FOSS APK. They now share one versionCode preflight but build in parallel.
